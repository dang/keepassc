...
class DBBrowser(object):
    ...
    def db_browser(self):
        ...
        unlocked_state = {
            ...
            ord(self.control.config['cancel']): self.exit2main,
            ord(self.control.config['quit']): self.quit_kpc,
            4: self.quit_kpc,
            ord(self.control.config['copy_password']): self.copy_password,
            ord(self.control.config['copy_username']): self.copy_username,
            ord(self.control.config['open_url']): self.open_url,
            ord(self.control.config['save']): self.pre_save,
            ord(self.control.config['save_as']): self.pre_save_as,
            ord(self.control.config['save_n_quit']): self.save_n_quit,
            ord(self.control.config['lock']): self.pre_lock,
            ord(self.control.config['change_db_password']): self.change_db_password,
            ord(self.control.config['create_group']): self.create_group,
            ord(self.control.config['create_sub_group']): self.create_sub_group,
            ord(self.control.config['create_entry']): self.create_entry,
            ord(self.control.config['delete']): self.pre_delete,
            ord(self.control.config['find_entries']): self.find_entries,
            ord('/'): self.find_entries,
            ord(self.control.config['edit_title']): self.edit_title,
            ord(self.control.config['edit_username']): self.edit_username,
            ord(self.control.config['edit_url']): self.edit_url,
            ord(self.control.config['edit_comment']): self.edit_comment,
            ord(self.control.config['edit_password']): self.edit_password,
            ord(self.control.config['edit_date']): self.edit_date,
            ord(self.control.config['show_hide']): self.show_password,
            ord(self.control.config['move']): self.move,
            ...
            ord(self.control.config['reload_remote_db']): self.reload_remote_db,
        }
        ...
        locked_state = {
            ...
            ord(self.control.config['nav_down']): self.nav_down_lock,
            cur.KEY_UP: self.nav_up_lock,
            ord(self.control.config['nav_up']): self.nav_up_lock,
            NL: self.unlock_db,
        ...
        move_states = {
            ...
            ord(self.control.config['nav_left']): self.go2parent,
            cur.KEY_RIGHT: self.go2sub,
            ord(self.control.config['nav_right']): self.go2sub,
        ...
        exceptions = (ord(self.control.config['save']),
                      ord(self.control.config['save_as']),
                      ord(self.control.config['change_db_password']),
                      ord(self.control.config['edit_title']),
                      ord(self.control.config['edit_password']),
                      ord(self.control.config['edit_username']),
                      ord(self.control.config['edit_url']),
                      ord(self.control.config['edit_comment']),
                      ord(self.control.config['edit_date']),
                      ord(self.control.config['show_hide']),
                      ord(self.control.config['create_group']),
                      ord(self.control.config['delete']),
                      ord(self.control.config['create_entry']),
                      ord(self.control.config['find_entries']),
                      ord('/'),
        ...
        while True:
            ...
            if self.state == 0:
                ...
                if c in unlocked_state:
                    unlocked_state[c]()
                if c == ord(self.control.config['cancel']):
                    return False
